...
namespace ME_Test
{
    ...
    public class PhotoData
    {
        ...
        private void Parse(IEnumerable<MetadataExtractor.Directory> directories)
        {
            // 日付・時刻
        ...
        private string GetString(IEnumerable<MetadataExtractor.Directory> directories, string directoryName, string tag)
        {
